...
def decomposenet(train_loader, val_loader, device, epochs):
    ...
    enhance_L_net = EnhanceNet_L_ablation()
   ...
   # best_ssim = -1
    ...
    #get_T_net.load_state_dict(torch.load('/home/jiangyonglong/program/Project3/save_model/get_T_net_epoch_498.pth'))
    #enhance_L_net.load_state_dict(torch.load('/home/jiangyonglong/program/Project3/save_model/enhance_L_net_epoch_498.pth'))
    enhance_L_net.load_state_dict(
        torch.load('/home/jiangyonglong/program/Project3/ablation/enhance_L_net_epoch_499.pth'))
    ...
    with torch.no_grad():
        ...
        for a, data2, in enumerate(train_loader):
            ...
            #val_low_l_part = val_low_l_part.to(device)
            val_low_im = val_low_im.to(device)
            ...
            #val_new_l_part = enhance_L_net(val_t, val_low_l_part) #t, low_l, low_r
            val_new_l_part = enhance_L_net(val_low_l_part)
            ...
            #            "/home/jiangyonglong/program/Project3/test_L_image/L_{}_{}.png".format(0, a),
            #            normalize=False)
            save_image(val_new_l_part,
                       "/home/jiangyonglong/program/Project3/test_L_image_ablation/L_{}_{}.png".format(0, a),
                       normalize=False)
            # save_image(val_new_l_part,
            #            "/home/jiangyonglong/program/Project3/666/L_{}_{}.png".format(0, a),
            #            normalize=False)
            # save_image(val_t,
            #            "/home/jiangyonglong/program/Project3/666/val_t_{}_{}.png".format(0, a),
            #            normalize=False)
            # save_image(val_low_r_part,
            #            "/home/jiangyonglong/program/Project3/666/val_low_r_{}_{}.png".format(0, a),
            #            normalize=False)
            # save_image(val_low_l_part,
            #            "/home/jiangyonglong/program/Project3/666/val_low_l_{}_{}.png".format(0, a),
            #            normalize=False)
            # save_image(val_high_r_part,
            #            "/home/jiangyonglong/program/Project3/666/val_high_r_{}_{}.png".format(0, a),
            #            normalize=False)
            # save_image(val_high_l_part,
            #            "/home/jiangyonglong/program/Project3/666/val_high_l_{}_{}.png".format(0, a),
            #            normalize=False)
                # save_image(val_out,
